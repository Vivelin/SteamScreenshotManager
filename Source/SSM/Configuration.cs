...
namespace SSM
{
  ...
  public class Configuration
  {
    ...
    public void Save()
    {
      ...
      {
        throw new Exception(string.Format("Settings could not be saved to \"{0}\".", this.FileName), ex);
      }
    }
    ...
    {
      if (!File.Exists(path)) throw new FileNotFoundException(string.Format("File does not exist: \"{0}\".", path), path);
      ...
      {
        throw new Exception(string.Format("Settings could not be loaded from \"{0}\".", path), ex);
      }
    }
